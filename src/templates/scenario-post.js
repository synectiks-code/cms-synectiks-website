          ...
          <div className='banner'>
            ...
            <div className='banner-icons-stack'>
              <div className='article'>
                <div className='icon'>
                  <img src={cycle} alt='' style={{ color: '#74bc21' }} />
                </div>
          ...
          <div className='main-section'>
            ...
            <div className='warehouse'>
              ...
              <div className='warehouse-right'>
                ...
                <p>
                  Lorem ipsum dolor sit amet, cons bh dolor, malesuada etili
                  adipDon nec malesu Lorem ipsum dolor sit amet, cons bh dolor,
                  malesuada etgutet. Lorem ipsum dolor sit amet, cons bh dolor,
                  malesuada etili adipDon nec malesu orem ipsum dolor sit amet,
                  cons bh dolor, malesuada etgutet…
                </p>
